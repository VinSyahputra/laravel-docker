...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-8 text-center">
        ...
        <p class="text-slate-500 max-w-md mx-auto">This is a mock page placeholder for your navigation links. You can start building your actual features by replacing this view.</p>
    </div>
@endsection
